...
## Auto Gatling
- Default : [_AntiLag  = false](https://github.com/K-M19/FurTDS/tree/main/Docs/Config#_antilag)
```lua
AutoGatling()
```
...
- Default : [_BackLobbyAfterMatch = 0](https://github.com/K-M19/FurTDS/tree/main/Docs/Config#_backlobbyaftermatch)
