    ...
    function a.b()
        ...
        function p.NewRoundFrame(r, u, v, x, B, C)
            ...
            local function getSliceCenterForType(F)
                return not table.find({"Shadow-sm", "Glass-0.7", "Glass-1", "Glass-1.4"}, F) and
                    Rect.new(256, 256, 256, 256) or
            ...
            local function UpdateSliceScale(J)
                local L =
                    not table.find({"Shadow-sm", "Glass-0.7", "Glass-1", "Glass-1.4"}, u) and (J / (256)) or (J / 512)
        ...
        function p.Image(v, x, B, C, F, G, H, J)
            ...
            elseif string.find(v, "http") then
                        ...
                        task.spawn(
                            function()
                                ...
                                if O then
                                    ...
                                    warn(
                                        string.format(
                                            "[ FurBox.Creator ] Failed to load custom asset '%s': %s",
                                            M,
                                            tostring(P)
                                        )
                                    )
                ...
                if not N then
                    warn(
                        "[ FurBox.Creator ]  '" .. identifyexecutor() .. "' doesnt support the URL Images. Error: " .. O
                    )
        ...
        function p.GetTextColorForHSB(v, x)
            local B = p.Color3ToHSB(v)
            local C, F, G = B.h, B.s, B.b
        ...
        return [[
{
        ...
        function aa.New(ae, af, ag, ah, ai, aj, ak, al)
            ...
            local ao =
                ...
                },
                {
                    ...
                    ab.NewRoundFrame(
                        am,
                        not ak and "Glass-1" or "Glass-0.7",
                        {
                            ThemeTag = {
                                ImageColor3 = "White"
                            },
    ...
    function a.u()
        ...
        function aa.New(ag, ah, ai, aj)
                ...
                function(ap)
                    if
                        (ap.UserInputType == Enum.UserInputType.MouseButton1 or
                            ap.UserInputType == Enum.UserInputType.Touch)
                     then
                ...
                function(ap)
                    if
                     ...
                     then
                        ...
                        aq =
                            ac.InputChanged:Connect(
                            function(as)
                                if
                                    as.UserInputType == Enum.UserInputType.MouseMovement or
            ...
            ad.AddSignal(
                ag:GetPropertyChangedSignal "AbsoluteWindowSize",
                function()
                    updateSliderSize()
                    updateThumbPosition()
                end
            ...
            ad.AddSignal(
                ag:GetPropertyChangedSignal "AbsoluteCanvasSize",
                function()
                    updateSliderSize()
                    updateThumbPosition()
                end
            ...
            ad.AddSignal(
                ag:GetPropertyChangedSignal "CanvasPosition",
                function()
                    if not an then
                        updateThumbPosition()
                    end
                ...
                if ai and aj and aj.__autoload then
                    ...
                    task.spawn(
                        function()
                            ...
                            if ak then
                                if ac.Debug then
                                    print("[ FurBox.ConfigManager ] AutoLoaded config: " .. af)
                                end
                            else
                                warn(
                                    "[ FurBox.ConfigManager ] Failed to AutoLoad config: " ..
                                        af .. " - " .. tostring(al)
                                )
                            end
                        end
    ...
    function a.P()
        ...
        function ah.New(aj, ak)
                    ...
                    af(
                        ...
                        0.33,
                        {
                            Size = UDim2.new(
                                ...
                                ar.Size.X.Offset,
                                0,
                                al.HeaderSize + (ar.Content.AbsoluteSize.Y / ak.UIScale)
                            )
                        },
                        Enum.EasingStyle.Quint,
                        Enum.EasingDirection.Out
            ...
            aa.AddSignal(
                ar.Content.UIListLayout:GetPropertyChangedSignal "AbsoluteContentSize",
                function()
                    if al.Opened then
                        al:Open()
                    end
                                        ...
                                        task.defer(
                                            function()
                                                ...
                                                if ax then
                                                    ...
                                                    warn(
                                                        "[ FurBox ] Failed to apply pending config for '" ..
                                                            ar.Flag .. "': " .. tostring(ay)
                                                    )
                                                end
                                            end
    ...
    function a.Y()
        ...
        return function(as)
            ...
            if au.Folder then
                if not isfolder("FurBox/" .. au.Folder) then
                    makefolder("FurBox/" .. au.Folder)
                end
                if not isfolder("FurBox/" .. au.Folder .. "/assets") then
                    makefolder("FurBox/" .. au.Folder .. "/assets")
                end
            ...
            if au.Acrylic then
                local ax, ay = aj.AcrylicPaint {UseAcrylic = au.Acrylic}
                ...
                if string.find(b, "http") then
                    ...
                    if not isfile(f) then
                        local g, h =
                            ...
                            function()
                                local g =
                                    ak.Request {Url = b, Method = "GET", Headers = {["User-Agent"] = "Roblox/Exploit"}}
                                writefile(f, g.Body)
                            end
                        )
                        if not g then
                            warn("[ FurBox.Window.Background ] Failed to download video: " .. tostring(h))
                            return
                        end
                    end
                    ...
                    if not g then
                        warn("[ FurBox.Window.Background ] Failed to load custom asset: " .. tostring(h))
                        return
                    end
            ...
            elseif d then
                ...
                if not isfile(f) then
                    local g, h =
                        ...
                        function()
                            local g =
                                ak.Request {Url = d, Method = "GET", Headers = {["User-Agent"] = "Roblox/Exploit"}}
                            writefile(f, g.Body)
                        end
                    )
                    if not g then
                                ...
                                },
                                {
                                    ...
                                    al(
                                        "Frame",
                                        {
                                            ...
                                            BackgroundTransparency = 1,
                                            Position = UDim2.new(
                                                au.Topbar.ButtonsType == "Default" and 1 or 0,
                                                0,
                                                0.5,
                                                0
                                            ),
            ...
            ak.AddSignal(
                ...
                function()
                    local l = 0
                    local m =
                        au.UIElements.Main.Main.Topbar.Right.UIListLayout.AbsoluteContentSize.X / as.FurBox.UIScale

                    l = au.UIElements.Main.Main.Topbar.Left.AbsoluteSize.X / as.FurBox.UIScale
                    if au.Topbar.ButtonsType ~= "Default" then
                        l = l + m + au.UIPadding - 4
                    end

                    au.UIElements.Main.Main.Topbar.Center.Position =
                        UDim2.new(0, l + (au.UIPadding / as.FurBox.UIScale), 0.5, 0)
                    au.UIElements.Main.Main.Topbar.Center.Size =
                        UDim2.new(1, -l - m - ((au.UIPadding * 2) / as.FurBox.UIScale), 1, 0)
                end
            )
            ...
            if au.Topbar.ButtonsType ~= "Default" then
                ak.AddSignal(
                    ...
                    function()
                        au.UIElements.Main.Main.Topbar.Left.Position =
                            UDim2.new(
                            0,
                            (au.UIElements.Main.Main.Topbar.Right.AbsoluteSize.X / as.FurBox.UIScale) + au.UIPadding - 4,
                            0,
                            0
                        )
                    end
            ...
            function au.CreateTopbarButton(l, m, p, r, u, v, x)
                ...
                B.Size =
                    au.Topbar.ButtonsType == "Default" and
                    UDim2.new(0, au.TopBarButtonIconSize, 0, au.TopBarButtonIconSize) or
                    UDim2.new(0, 0, 0, 0)
                ...
                local C =
                    ...
                    "Squircle",
                    {
                        Size = au.Topbar.ButtonsType == "Default" and
                            UDim2.new(0, au.Topbar.Height - 16, 0, au.Topbar.Height - 16) or
                            UDim2.new(0, 14, 0, 14),
            ...
            if not aE and au.Background and typeof(au.Background) == "table" then
                ...
                au.UIElements.BackgroundGradient =
                    ak.NewRoundFrame(
                    au.UICorner,
                    "Squircle",
                    {
                        ...
                        ImageTransparency = au.Transparent and as.FurBox.TransparencyValue or 0
                    },
                    {
                        m
                    }
            ...
            function au.ToggleFullscreen(r)
                ...
                am(
                    au.UIElements.Main,
                    0.45,
                    {Size = u and p or UDim2.new(1, -20, 1, -72)},
                    Enum.EasingStyle.Quint,
                    Enum.EasingDirection.Out
                ):Play()
                ...
                am(
                    au.UIElements.Main,
                    0.45,
                    {Position = u and m or UDim2.new(0.5, 0, 0.5, 26)},
                    Enum.EasingStyle.Quint,
                    Enum.EasingDirection.Out
                ):Play()
                ...
                function u.Destroy(v)
                    task.spawn(
                        function()
                            ...
                            au.Destroyed = true
                            task.wait(0.4)
                            as.FurBox.ScreenGui:Destroy()
                            as.FurBox.NotificationGui:Destroy()
                            as.FurBox.DropdownGui:Destroy()
                            as.FurBox.TooltipGui:Destroy()
            ...
            function au.ToggleTransparency(r, u)
                au.Transparent = u
                as.FurBox.Transparent = u

                au.UIElements.Main.Background.ImageTransparency = u and as.FurBox.TransparencyValue or 0
            ...
            function au.GetUIScale(r, u)
                return as.FurBox.UIScale
            end

            function au.SetUIScale(r, u)
                as.FurBox.UIScale = u
                am(as.FurBox.UIScaleObj, .2, {Scale = u}, Enum.EasingStyle.Quint, Enum.EasingDirection.Out):Play()
                return au
            end
            ...
            if au.OpenButtonMain and au.OpenButtonMain.Button then
                ak.AddSignal(
                    au.OpenButtonMain.Button.TextButton.MouseButton1Click,
                    function()
                        au:Open()
                    end
                )
            ...
            local r = a.load "U"
            local u = a.load "V"
            local v = r.Init(au, as.FurBox, as.FurBox.TooltipGui)
            v:OnChange(
                function(x)
                    au.CurrentTab = x
                end
            ...
            function au.Tab(x, B)
                ...
                return v.New(B, as.FurBox.UIScale)
            end
            ...
            function au.Section(x, B)
                return u.New(B, au.UIElements.SideBar.Frame, au.Folder, as.FurBox.UIScale, au)
            end
            ...
            function au.Dialog(B, C)
                ...
                local J
                if C.Icon then
                    J = ak.Image(C.Icon, F.Title .. ":" .. C.Icon, 0, au, "Dialog", true, C.IconThemed)
                    J.Size = UDim2.new(0, 22, 0, 22)
                    J.Parent = H
                end

                G.UIElements.UIListLayout =
                    al(
                    "UIListLayout",
                    {
                        Padding = UDim.new(0, 12),
                ...
                local function CheckButtonsOverflow()
                    ...
                    local S = L.AbsoluteContentSize.X / as.FurBox.UIScale
                    local T = M.AbsoluteSize.X / as.FurBox.UIScale
                    ...
                    if S > T then
                        ...
                        if U > 0 then
                            ...
                            for X, Y in ipairs(N) do
                                local _ = Y.AbsoluteSize.X / as.FurBox.UIScale
                                if _ < W then
                                    W = _
                                    V = Y
                                end
            ...
            f.Frame.MouseButton1Up:Connect(
                function()
                    local H = tick()
                    local J = au.Position
